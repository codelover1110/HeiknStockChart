...
strategy = 'heikfilter'
SAVE_TIME_INTERVAL = 60*15 # seconds
...
class SaveActionThread(object):
    def __init__(self):
        ...
        self._stop = False
        self.trading_log_file = "logs/"+strategy+"-trades.csv"
        self.save_action_file = "logs/"+strategy+"-trades-save.csv"
        ...
        if ob_table.count_documents(query) > 0:     # update candle
            ...
            newvalues = {
                "$set": {
                    ...
                    "quantity": new_action['quantity'],
                    "side": new_action['side'],
                    "strategy": new_action['strategy']
                }
            }
            print ('{} update ===> trade date: {}'.format(db_name, str(trade_date)))
            ob_table.update_one(updatequery, newvalues)
            ...
            print('{} insert ===> before date: {}, trade_date: {}'.format(db_name, str(data_result['date']), str(trade_date)))
            ...
            insert_candle['strategy'] = new_action['strategy']
    ...
    def save_actions_database(self, new_action):
        ...
        try:
            ...
            new_action['strategy'] = csv_file_name
