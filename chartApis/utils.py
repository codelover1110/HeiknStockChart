...
def get_combine_data_chadAPI(sym, timeframe, bars, close, extended_hours):
    # http://40.67.136.227/combined/?symbol=TSLA&timeframe=1ho&bars=100&close=false&extended_hours=true&asset_class=equities&key=Thohn9po1mai7ba&endpoints=raw-bars,tsr,heik,rsi1
